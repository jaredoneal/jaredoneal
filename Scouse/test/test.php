...
$textarray = explode("\n", $sonnet1);
$randquote = array_rand($textarray, 199);
echo $textarray[$randquote[0]];
echo $textarray[$randquote[1]];
echo $textarray[$randquote[2]];
echo $textarray[$randquote[3]];
echo $textarray[$randquote[4]];
echo $textarray[$randquote[5]];
